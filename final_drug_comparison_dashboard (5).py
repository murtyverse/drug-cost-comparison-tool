...
sections = st.sidebar.multiselect(
    ...
    ["💊 Price Comparison", "📊 Generic vs Brand", "💰 Savings Estimator", "🧠 Smart Substitution"],
    default=["💊 Price Comparison", "📊 Generic vs Brand", "💰 Savings Estimator", "🧠 Smart Substitution"]
)
...
# 🧠 Smart Drug Substitution
if "🧠 Smart Substitution" in sections and drug_selections:
    st.subheader("🧠 Smart Drug Substitution")
    for drug in drug_selections:
