...
# 💊 Price Comparison
if "💊 Price Comparison" in sections and drug_selections:
...
if "📊 Generic vs Brand" in sections and drug_selections:
...
# 💰 Savings Estimator
if "💰 Savings Estimator" in sections and drug_selections:
...
if "🧠 Therapeutic Alternatives" in sections and drug_selections:
