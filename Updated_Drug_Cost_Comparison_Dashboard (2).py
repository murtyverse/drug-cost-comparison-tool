...
drug_data = {
    ...
    "Amlodipine (Hypertension)": {"dosages": ["5mg", "10mg"], "generic_price": 11, "brand_price": 32}
}
...
insurance_coverage = {
    "Atorvastatin (Cholesterol)": 0.7,
    "Lisinopril (Blood Pressure)": 0.8,
    "Metformin (Diabetes)": 0.85,
    "Omeprazole (Acid Reflux)": 0.6,
    "Amlodipine (Hypertension)": 0.75
}
